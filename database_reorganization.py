...
#This gets all column names from a table
#conn.execute('''SELECT * FROM information_schema.columns WHERE table_schema = 'public' AND table_name = '{}';'''.format('Sec_State_Bureaucratic_Exchange'))

#This gets all table names in the database
...
for table_name in all_Tables_OBJ[2]:
    if str(name) not in not_a_table_name:
        print(name)
"""
